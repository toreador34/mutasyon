...
<?php
/*%%SmartyHeaderCode:147047118571a002f9c25d1_19743192%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '81674bf297f95c8bb8c9df2a97e290c27660587a' => 
    array (
      0 => '/var/www/html/mutasyon/themes/default/service/cancelserviceinvoice.html',
      1 => 1458488788,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147047118571a002f9c25d1_19743192',
  'variables' => 
  array (
    '_cancel_invoice' => 0,
    '_refund' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_571a002f9e68e6_51430559',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_571a002f9e68e6_51430559')) {
function content_571a002f9e68e6_51430559 ($_smarty_tpl) {
if (!is_callable('smarty_modifier_date_format')) require_once '/var/www/html/mutasyon/libs/plugins/modifier.date_format.php';

$_smarty_tpl->properties['nocache_hash'] = '147047118571a002f9c25d1_19743192';
?>
<div class="collapse topwind" id="cancelinvoice">
      <div class="panel panel-pink" style="background:#fff">
	      ...
	      <div class="panel-body pan">
		   <form action="cancelinvoice.php" method="POST" class="reload">
...
" class="form-control" />
						...
						<div class="col-sm-12">
						      <label class="margin-top">Hizmet Ücretini de Tahsil Et</label>
						      <div class="material-switch pull-right">
							  <input id="someSwitchOptionSuccess" name="collectproviders" type="checkbox"/>
							  <label for="someSwitchOptionSuccess" class="label-success"></label>
						      </div>
						      <input type="hidden" name="collectprovidersdesc" class="form-control" />
						</div>
						<div class="col-sm-12">
...
"></i>
						...
						<div class="form-actions text-right pal">
						      <button type="submit" class="btn btn-info btn-xs margin-top cancelservicesubmit"><?php echo $_smarty_tpl->tpl_vars['_payment']->value;?>
</button>
						</div>
			    </div>
		    </form>   
